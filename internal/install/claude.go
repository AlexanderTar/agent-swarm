...
func CheckClaude(ctx context.Context, c Config, run execx.Runner, sessions ClaudeSessionsFunc) []Check {
	return []Check{CheckSkills(c, KindClaude), CheckClaudeTrust(ctx, c, run, sessions)}
}
