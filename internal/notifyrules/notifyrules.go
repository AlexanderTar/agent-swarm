...
var Rules = map[string]Rule{
	...
	"request.prompt":          {"action", "Approval needed", "{KEY}: {name} is waiting on approval: {prompt}", "swarm.question"},
	"request.blocker":         {"action", "Blocker reported", "{KEY}: {name} is blocked: {prompt}", "swarm.question"},
