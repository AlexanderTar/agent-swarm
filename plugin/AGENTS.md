...
Use the local Swarm MCP server and board at http://127.0.0.1:7777 for deliberate, plan-backed work. Sessions, hooks, CLI-spawned agents, subagents, advisors, reviewers, tool calls, and handoffs **never create tasks automatically**.
