...
public enum Copy {
    ...
    public static let orchestrators = "Orchestrators:"
    public static let remoteControl = "Remote control"
    public static let remoteControlCaption = "Lets you watch and steer an orchestrator's Claude session from another device. Off by default."
