...
func TestScenario03ForgedApproval(t *testing.T) {
 ...
 "children":[{"ref":"s1","type":"story","title":"Server","brief":"","acceptance":[],
   "children":[{"ref":"t1","type":"task","title":"Do it","brief":"","acceptance":[],"role_hint":"coder","repos":[],"workflow":{"template":"tdd-reviewed"},"steps":["Write test","Implement"],"verify":["go test ./..."],"solo":"focused"}]}]}` +
		"\n```\n\n## Verification\n\ngo test ./...\n"
